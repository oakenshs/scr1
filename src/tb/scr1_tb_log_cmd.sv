...
always_ff @(posedge scr1_top_tb_ahb.i_top.i_imem_ahb.clk) begin
    if (scr1_top_tb_ahb.i_top.i_imem_ahb.imem_resp == 2'b01) begin
        ...
        if (
            ...
            // $display("ahb_imem_req_ack: 0x%h", scr1_top_tb_ahb.i_top.i_imem_ahb.ahb_imem_req_ack);
            ...
            $display("mepc: 0x%h", scr1_top_tb_ahb.i_top.i_core_top.i_pipe_top.i_pipe_csr.csr_mepc);
